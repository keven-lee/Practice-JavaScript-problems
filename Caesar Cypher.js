 ...
 function caesar_cipher(offset, str) {
     return str.split('').map(function(value, index) {
         if ((value.charCodeAt() + offset) > 'z'.charCodeAt()) {
             return String.fromCharCode('a'.charCodeAt() + value.charCodeAt() + offset - 'z'.charCodeAt() - 1);
         } else {
             return String.fromCharCode(value.charCodeAt() + offset);
         }
     }).join('');
 }
 ...
 console.log("===============================================")
 console.log(
     'caesar_cipher(3, "abc") == "def": ' + (caesar_cipher(3, 'abc') == 'def'))
 console.log(
     'caesar_cipher(3, "abc xyz") == "def abc": ' + (caesar_cipher(3, 'abc xyz') == 'def abc'))
 console.log("===============================================")